...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        LPCWSTR path = L"\\\\.\\PhysicalDrive0"; //where create tmp file
        string selected_f = argv[1];
        HANDLE arrHandler = CreateFile(path, GENERIC_ALL, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, NULL, NULL); //save args in random tmp file & ignore err its compiling anyway with g++
